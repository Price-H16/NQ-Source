                            ...
                            switch (evt.MapInstance.MapInstanceType)
                            {
                                case MapInstanceType.TimeSpaceInstance:
                                    ...
                                    var client = evt.MapInstance.Sessions.ToList()
                                                    .Where(s => s.Character?.Timespace != null).FirstOrDefault();
...
#warning Check EndState and monsters to kill
                                        var MapInstanceId =
                                                ServerManager.GetBaseMapInstanceIdByMapId(client.Character.MapId);
                                        var si = ServerManager.Instance.TimeSpaces.FirstOrDefault(s =>
