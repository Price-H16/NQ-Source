...
namespace OpenNos.Master.Library.Interface
{
    ...
    public interface ICommunicationService
    {
        ...
        /// <summary>
        ///     Returns if desired character is being saved
        /// </summary>
        bool IsCharacterSaving(long characterId);
        
        /// <summary>
        ///     Adds or removes a CharacterId from the SavingCharacters list
        /// </summary>
        /// <param name="add">It will, if true, aggregate to the list, if false, remove from the list</param>
